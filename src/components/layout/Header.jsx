...
const Header = () => {
  return (
    <header className="text-slate-700 relative flex flex-col overflow-hidden px-4 lg:px-20 py-4 md:mx-auto md:flex-row md:items-center">
      <Link
        href="/"
      ...
      >
        <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
          ...
          <li className="md:mr-12">
            <button className="rouned-md border-2 border-blue-600 px-6 py-1 text-blue-600 font-bold transition-colors hover:bg-blue-600 hover:text-white">
              Demo
            </button>
          </li>
        </ul>
